...
grid = pd.concat([main_grid, gov_grid, mine_grid], axis=1)

del gov_grid, mine_grid, main_grid
...
grid.to_csv(path+"/pre_panel_corrected.csv", index=False, encoding="utf-8")
...
with open(path+"/pre_panel_corrected.csv") as f, open(path+"/panel_corrected.csv", "w") as f2:
