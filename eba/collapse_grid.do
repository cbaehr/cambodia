...
drop province_name province_number district_name district_number commune_name commune_number latitude longitude treecover1999 temperature1999 temperature2000 temperature2018 precip1999 precip2017 precip2018
su
...
collapse (count) count=cell_id (mean) `r(varlist)', by(cell_id_x)


su
export delimited "$data/1km_grid_mine.csv", replace
