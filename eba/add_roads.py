...
treatment_grid = pd.read_csv(path+"/roadsandbridges_grid.csv")
...
for i in ["tc", "ndvi", "treatment_roadsandbridges1000_", "treatment_roadsandbridges2000_", "treatment_roadsandbridges3000_", "treatment_roadsandbridges4000_", "treatment_roadsandbridges5000_", "temp_", "precip_"]:
...
for i in ["treecover", "ndvi", "trt1km_roads", "trt2km_roads", "trt3km_roads", "trt4km_roads", "trt5km_roads", "temperature", "precip"]:
	for j in range(1999, 2019):
...
grid.to_csv(output+"/pre_panel_corrected_roads.csv", index=False, encoding="utf-8")
...
with open(output+"/pre_panel_corrected_roads.csv") as f, open(output+"/panel_corrected_roads.csv", "w") as f2:
	a=f2.write("cell_id,year,longitude,latitude,province_number,province_name,district_number,district_name,commune_number,commune_name,plantation,concession,protected_area,dist_to_city,dist_to_road,popdensity2000,dist_to_minecasualty,treecover,ndvi,trt1km_roads,trt2km_roads,trt3km_roads,trt4km_roads,trt5km_roads,temperature,precip\n")
